...
const (
	TodoService_CreateTask_FullMethodName   = "/grpc_todo.TodoService/CreateTask"
	TodoService_ReadTask_FullMethodName     = "/grpc_todo.TodoService/ReadTask"
	TodoService_UpdateTask_FullMethodName   = "/grpc_todo.TodoService/UpdateTask"
	TodoService_DeleteTask_FullMethodName   = "/grpc_todo.TodoService/DeleteTask"
	TodoService_CompleteTask_FullMethodName = "/grpc_todo.TodoService/CompleteTask"
)
...
type TodoServiceClient interface {
	...
	ReadTask(ctx context.Context, in *TaskRequest, opts ...grpc.CallOption) (*Task, error)
	...
	CompleteTask(ctx context.Context, in *TaskComplete, opts ...grpc.CallOption) (*Task, error)
}
...
func (c *todoServiceClient) ReadTask(ctx context.Context, in *TaskRequest, opts ...grpc.CallOption) (*Task, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Task)
	err := c.cc.Invoke(ctx, TodoService_ReadTask_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *todoServiceClient) DeleteTask(ctx context.Context, in *TaskRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *todoServiceClient) CompleteTask(ctx context.Context, in *TaskComplete, opts ...grpc.CallOption) (*Task, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Task)
...
func (UnimplementedTodoServiceServer) ReadTask(context.Context, *TaskRequest) (*Task, error) {
...
func (UnimplementedTodoServiceServer) DeleteTask(context.Context, *TaskRequest) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteTask not implemented")
}
func (UnimplementedTodoServiceServer) CompleteTask(context.Context, *TaskComplete) (*Task, error) {
...
func _TodoService_ReadTask_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TodoService_ReadTask_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TodoServiceServer).ReadTask(ctx, req.(*TaskRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _TodoService_DeleteTask_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TodoServiceServer).DeleteTask(ctx, req.(*TaskRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _TodoService_CompleteTask_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TodoServiceServer).CompleteTask(ctx, req.(*TaskComplete))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TodoService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "grpc_todo.TodoService",
